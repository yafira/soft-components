...
export default function LibraryGrid() {
  ...
  return (
    <section id="library" className="wrap">
      <div className={styles.categoryLabel} style={{ '--label-bg': color.lavenderBeamTint, '--label-border': 'var(--wisteria-deep)' } as CSSProperties}>input</div>
      <div className={styles.grid}>

        <article className={styles.card}>
          <button className={styles.demoTrigger} aria-label="animate the soft button demo" onClick={playButton}>
            <svg viewBox="0 0 220 150" role="img" className={styles.thumb}>
              ...
              <g ref={feltRef} style={{ transformBox: 'view-box', transformOrigin: '110px 61px' }}>
                <rect x="60" y="32" width="100" height="58" rx="18" className={styles.fillBlush} />
                <text x="110" y="66" textAnchor="middle" className={styles.labelBlush}>Felt</text>
              </g>
              <rect x="72" y="102" width="76" height="11" rx="4" className={styles.fillButter} />
              <text ref={btnStateRef} x="110" y="138" textAnchor="middle" className={styles.state}>Circuit open</text>
            </svg>
          </button>
          <div className={styles.cardBody}>
            ...
            <Link className={styles.more} href="/components/soft-button">how it works →</Link>
          </div>
        </article>

        <article className={styles.card}>
          <button className={styles.demoTrigger} aria-label="animate the soft potentiometer demo" onClick={playPot}>
            <svg viewBox="0 0 220 150" role="img" className={styles.thumb}>
              <title>fabric potentiometer demo</title>
              <rect x="30" y="62" width="160" height="18" rx="9" className={styles.fillMatcha} />
              <circle ref={wiperRef} cx="52" cy="71" r="14" fill="#fdfbf7" stroke="#4f9c74" strokeWidth={2} />
              <text ref={potValueRef} x="110" y="118" textAnchor="middle" className={styles.mono}>0.14</text>
              <text x="110" y="138" textAnchor="middle" className={styles.state}>Position → value</text>
            </svg>
          </button>
          <div className={styles.cardBody}>
            ...
            <Link className={styles.more} href="/components/soft-potentiometer">how it works →</Link>
          </div>
        </article>

        <article className={styles.card}>
          <button className={styles.demoTrigger} aria-label="animate the pressure sensor demo" onClick={playPressure}>
            <svg viewBox="0 0 220 150" role="img" className={styles.thumb}>
              ...
              <text ref={pressValueRef} x="110" y="122" textAnchor="middle" className={styles.mono}>R: high</text>
              <text x="110" y="140" textAnchor="middle" className={styles.state}>Squeeze → signal</text>
            </svg>
          </button>
          <div className={styles.cardBody}>
            ...
            <Link className={styles.more} href="/components/pressure-sensor">how it works →</Link>
          </div>
        </article>

        <article className={styles.card}>
          <button className={styles.demoTrigger} aria-label="animate the knit stretch sensor demo" onClick={playKnit}>
            <svg viewBox="0 0 220 150" role="img" className={styles.thumb}>
              ...
              <text x="110" y="118" textAnchor="middle" className={styles.mono}>R rises</text>
              <text x="110" y="138" textAnchor="middle" className={styles.state}>Stretch → resistance</text>
            </svg>
          </button>
          <div className={styles.cardBody}>
            ...
            <Link className={styles.more} href="/components/knit-stretch-sensor">how it works →</Link>
          </div>
        </article>

        <article className={styles.card}>
          <button className={styles.demoTrigger} aria-label="animate the capacitive touch matrix demo" onClick={playMatrix}>
            <svg viewBox="0 0 220 150" role="img" className={styles.thumb}>
              ...
              <text x="110" y="118" textAnchor="middle" className={styles.mono}>Multi-touch</text>
              <text x="110" y="138" textAnchor="middle" className={styles.state}>Grid → independent pads</text>
            </svg>
          </button>
          <div className={styles.cardBody}>
            ...
            <Link className={styles.more} href="/components/capacitive-touch-matrix">how it works →</Link>
          </div>
        </article>

        <article className={styles.card}>
          <button className={styles.demoTrigger} aria-label="animate the fabric bend sensor demo" onClick={playBend}>
            <svg viewBox="0 0 220 150" role="img" className={styles.thumb}>
              ...
              <text x="110" y="118" textAnchor="middle" className={styles.mono}>R rises</text>
              <text x="110" y="138" textAnchor="middle" className={styles.state}>Bend → resistance</text>
            </svg>
          </button>
          <div className={styles.cardBody}>
            ...
            <Link className={styles.more} href="/components/fabric-bend-sensor">how it works →</Link>
          </div>
        </article>
      ...
      <div className={styles.grid}>
        ...
        <article className={styles.card}>
          <button className={styles.demoTrigger} aria-label="animate the haptic motor demo" onClick={playHaptic}>
            <svg viewBox="0 0 220 150" role="img" className={styles.thumb}>
              ...
              <text x="110" y="118" textAnchor="middle" className={styles.mono}>Buzz</text>
              <text x="110" y="138" textAnchor="middle" className={styles.state}>Press → felt confirms</text>
            </svg>
          </button>
          <div className={styles.cardBody}>
            ...
            <Link className={styles.more} href="/components/haptic-motor">how it works →</Link>
          </div>
        </article>

        <article className={styles.card}>
          <button className={styles.demoTrigger} aria-label="animate the thermochromic reveal demo" onClick={playThermo}>
            <svg viewBox="0 0 220 150" role="img" className={styles.thumb}>
              ...
              <text x="110" y="118" textAnchor="middle" className={styles.mono}>Warms · fades</text>
              <text x="110" y="138" textAnchor="middle" className={styles.state}>Heat → color shift</text>
            </svg>
          </button>
          <div className={styles.cardBody}>
            ...
            <Link className={styles.more} href="/components/thermochromic-reveal">how it works →</Link>
          </div>
        </article>
      ...
      <div className={styles.grid}>
        ...
        <article className={styles.card}>
          <button className={styles.demoTrigger} aria-label="animate the e-ink refresh demo" onClick={playEink}>
            <svg viewBox="0 0 220 150" role="img" className={styles.thumb}>
              <title>e-ink refresh demo</title>
              <rect ref={einkPanelRef} x="50" y="30" width="120" height="60" rx="8" fill="#f4f0fb" stroke="var(--line)" />
              <text x="110" y="118" textAnchor="middle" className={styles.mono}>Flash · settle</text>
              <text x="110" y="138" textAnchor="middle" className={styles.state}>Refresh → clears ghosting</text>
            </svg>
          </button>
          <div className={styles.cardBody}>
